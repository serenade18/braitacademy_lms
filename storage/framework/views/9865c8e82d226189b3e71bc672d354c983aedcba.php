    ...
    <div id="collapseRelatedCourse<?php echo e(!empty($relatedCourse) ? $relatedCourse->id :'record'); ?>" aria-labelledby="relatedCourse_<?php echo e(!empty($relatedCourse) ? $relatedCourse->id :'record'); ?>" class=" collapse <?php if(empty($relatedCourse)): ?> show <?php endif; ?>" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="related-course-form" data-action="/panel/relatedCourses/<?php echo e(!empty($relatedCourse) ? $relatedCourse->id . '/update' : 'store'); ?>">
                <input type="hidden" name="ajax[<?php echo e(!empty($relatedCourse) ? $relatedCourse->id : 'new'); ?>][item_id]" value="<?php echo e($product->id); ?>">
                <input type="hidden" name="ajax[<?php echo e(!empty($relatedCourse) ? $relatedCourse->id : 'new'); ?>][item_type]" value="product">
...
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\web\default\panel\store\products\create_includes\accordions\related_courses.blade.php ENDPATH**/ ?>