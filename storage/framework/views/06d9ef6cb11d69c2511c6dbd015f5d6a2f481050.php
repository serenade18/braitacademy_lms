    ...
    <div class="col-12 col-md-4 mt-15">
        ...
        <?php if(!empty(getGeneralSettings('content_translate'))): ?>
            <div class="form-group">
                ...
                <select name="locale" class="custom-select <?php echo e(!empty($upcomingCourse) ? 'js-edit-content-locale' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>">
                <option value="webinar" <?php if(!empty($upcomingCourse) and $upcomingCourse->type == 'webinar'): ?> selected <?php endif; ?>><?php echo e(trans('webinars.webinar')); ?></option>
                <option value="course" <?php if(!empty($upcomingCourse) and $upcomingCourse->type == 'course'): ?> selected <?php endif; ?>><?php echo e(trans('webinars.video_course')); ?></option>
                <option value="text_lesson" <?php if(!empty($upcomingCourse) and $upcomingCourse->type == 'text_lesson'): ?> selected <?php endif; ?>><?php echo e(trans('webinars.text_lesson')); ?></option>
            </select>
...
unset($__errorArgs, $__bag); ?>">
                    <option value="" <?php echo e((!empty($upcomingCourse) and !empty($upcomingCourse->teacher_id)) ? '' : 'selected'); ?>><?php echo e(trans('public.choose_instructor')); ?></option>
                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($teacher->id); ?>" <?php echo e((!empty($upcomingCourse) && $upcomingCourse->teacher_id == $teacher->id) ? 'selected' : ''); ?>><?php echo e($teacher->full_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="title" value="<?php echo e((!empty($upcomingCourse) and !empty($upcomingCourse->translate($locale))) ? $upcomingCourse->translate($locale)->title : old('title')); ?>" class="form-control <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="seo_description" value="<?php echo e((!empty($upcomingCourse) and !empty($upcomingCourse->translate($locale))) ? $upcomingCourse->translate($locale)->seo_description : old('seo_description')); ?>" class="form-control <?php $__errorArgs = ['seo_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            ...
            <div class="input-group">
                ...
                <input type="text" name="image_cover" id="cover_image" value="<?php echo e(!empty($upcomingCourse) ? $upcomingCourse->image_cover : old('image_cover')); ?>" placeholder="<?php echo e(trans('forms.course_cover_size')); ?>" class="form-control <?php $__errorArgs = ['image_cover'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="js-video-demo-other-inputs form-group mt-0 <?php echo e((empty($upcomingCourse) or $upcomingCourse->video_demo_source != 'secure_host') ? '' : 'd-none'); ?>">
            ...
            <div class="input-group js-video-demo-path-input">
                <div class="input-group-prepend">
                    <button type="button" class="js-video-demo-path-upload input-group-text text-white panel-file-manager <?php echo e((empty($upcomingCourse) or empty($upcomingCourse->video_demo_source) or $upcomingCourse->video_demo_source == 'upload') ? '' : 'd-none'); ?>" data-input="demo_video" data-preview="holder">
                        <i data-feather="upload" width="18" height="18" class="text-white"></i>
                    </button>

                    <button type="button" class="js-video-demo-path-links rounded-left input-group-text input-group-text-rounded-left text-white <?php echo e((empty($upcomingCourse) or empty($upcomingCourse->video_demo_source) or $upcomingCourse->video_demo_source == 'upload') ? 'd-none' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(trans('forms.webinar_description_placeholder')); ?>"><?php echo (!empty($upcomingCourse) and !empty($upcomingCourse->translate($locale))) ? $upcomingCourse->translate($locale)->description : old('description'); ?></textarea>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\web\default\panel\upcoming_courses\create_includes\step_1.blade.php ENDPATH**/ ?>