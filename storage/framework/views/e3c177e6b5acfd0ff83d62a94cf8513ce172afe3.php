    ...
    <div id="collapseTicket<?php echo e(!empty($ticket) ? $ticket->id :'record'); ?>" aria-labelledby="ticket_<?php echo e(!empty($ticket) ? $ticket->id :'record'); ?>" class=" collapse <?php if(empty($ticket)): ?> show <?php endif; ?>" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="js-content-form ticket-form" data-action="/panel/tickets/<?php echo e(!empty($ticket) ? $ticket->id . '/update' : 'store'); ?>">
                <input type="hidden" name="ajax[<?php echo e(!empty($ticket) ? $ticket->id : 'new'); ?>][bundle_id]" value="<?php echo e(!empty($bundle) ? $bundle->id :''); ?>">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="ajax[<?php echo e(!empty($ticket) ? $ticket->id : 'new'); ?>][locale]"
                                        class="form-control <?php echo e(!empty($ticket) ? 'js-bundle-content-locale' : ''); ?>"
                ...
                <div class="row">
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ajax[<?php echo e(!empty($ticket) ? $ticket->id : 'new'); ?>][capacity]" class="js-ajax-capacity form-control mt-10" value="<?php echo e(!empty($ticket) ? $ticket->capacity :''); ?>" placeholder="<?php echo e(trans('forms.empty_means_unlimited')); ?>"/>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\web\default\panel\bundle\create_includes\accordions\ticket.blade.php ENDPATH**/ ?>