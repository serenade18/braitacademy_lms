    ...
    <div id="collapseRelatedCourse<?php echo e(!empty($relatedCourse) ? $relatedCourse->id :'record'); ?>" aria-labelledby="relatedCourse_<?php echo e(!empty($relatedCourse) ? $relatedCourse->id :'record'); ?>" class=" collapse <?php if(empty($relatedCourse)): ?> show <?php endif; ?>" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="related-course-form" data-action="/panel/relatedCourses/<?php echo e(!empty($relatedCourse) ? $relatedCourse->id . '/update' : 'store'); ?>">
                <input type="hidden" name="ajax[<?php echo e(!empty($relatedCourse) ? $relatedCourse->id : 'new'); ?>][item_id]" value="<?php echo e($upcomingCourse->id); ?>">
                <input type="hidden" name="ajax[<?php echo e(!empty($relatedCourse) ? $relatedCourse->id : 'new'); ?>][item_type]" value="upcomingCourse">

                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="form-group mt-15">
                            <label class="input-label d-block"><?php echo e(trans('update.select_related_courses')); ?></label>
                            <select name="ajax[<?php echo e(!empty($relatedCourse) ? $relatedCourse->id : 'new'); ?>][course_id]" class="js-ajax-course_id form-control <?php if(!empty($relatedCourse)): ?> panel-search-webinar-select2 <?php else: ?> relatedCourses-select2 <?php endif; ?>" data-placeholder="<?php echo e(trans('update.search_courses')); ?>">
...
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\web\default\panel\upcoming_courses\create_includes\accordions\related_courses.blade.php ENDPATH**/ ?>