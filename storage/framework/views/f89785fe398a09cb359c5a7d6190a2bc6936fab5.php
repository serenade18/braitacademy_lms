...
<div class="row">
    <div class="col-12 mt-20">
        <div class="">
            ...
            <button type="button" id="productAddSpecification" class="btn btn-primary btn-sm mt-10"><?php echo e(trans('update.new_specification')); ?></button>
        </div>
            ...
            <?php if(!empty($product->selectedSpecifications) and count($product->selectedSpecifications)): ?>
                <ul class="draggable-lists" data-order-path="/panel/store/products/specifications/order-items">
                    <?php $__currentLoopData = $product->selectedSpecifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selectedSpecificationRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('web.default.panel.store.products.create_includes.accordions.specification',['selectedSpecification' => $selectedSpecificationRow], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div id="newSpecificationForm" class="d-none">
            <?php echo $__env->make('web.default.panel.store.products.create_includes.accordions.specification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    ...
    <div class="col-12 mt-40">
            ...
            <?php if(!empty($product->faqs) and count($product->faqs)): ?>
                <ul class="draggable-lists2" data-order-path="/panel/store/products/faqs/order-items">
                    <?php $__currentLoopData = $product->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faqRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('web.default.panel.store.products.create_includes.accordions.faq',['faq' => $faqRow], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            <?php else: ?>
                <?php echo $__env->make(getTemplate() . '.includes.no-result',[
        ...
        <div id="newFaqForm" class="d-none">
            <?php echo $__env->make('web.default.panel.store.products.create_includes.accordions.faq', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\web\default\panel\store\products\create_includes\step_4.blade.php ENDPATH**/ ?>