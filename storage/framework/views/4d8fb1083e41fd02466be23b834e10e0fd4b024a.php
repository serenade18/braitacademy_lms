    ...
    <div id="collapseFaq<?php echo e(!empty($faq) ? $faq->id :'record'); ?>" aria-labelledby="faq_<?php echo e(!empty($faq) ? $faq->id :'record'); ?>" class=" collapse <?php if(empty($faq)): ?> show <?php endif; ?>" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="js-content-form faq-form" data-action="/panel/faqs/<?php echo e(!empty($faq) ? $faq->id . '/update' : 'store'); ?>">
                <input type="hidden" name="ajax[<?php echo e(!empty($faq) ? $faq->id : 'new'); ?>][upcoming_course_id]" value="<?php echo e(!empty($upcomingCourse) ? $upcomingCourse->id :''); ?>">
                        ...
                        <?php if(!empty(getGeneralSettings('content_translate'))): ?>
                            <div class="form-group">
                                ...
                                <select name="ajax[<?php echo e(!empty($faq) ? $faq->id : 'new'); ?>][locale]"
                                        class="form-control <?php echo e(!empty($faq) ? 'js-upcoming-course-content-locale' : ''); ?>"
...
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\web\default\panel\upcoming_courses\create_includes\accordions\faq.blade.php ENDPATH**/ ?>