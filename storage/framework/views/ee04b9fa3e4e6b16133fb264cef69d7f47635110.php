...
unset($__errorArgs, $__bag); ?>">
                <?php $__currentLoopData = \App\Models\AbandonedCartRule::$targetTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15 js-select-target-field <?php echo e((empty($rule) or $rule->target_type == "all") ? 'd-none' : ''); ?>">
...
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\admin\abandoned_cart\rules\create\target_products.blade.php ENDPATH**/ ?>