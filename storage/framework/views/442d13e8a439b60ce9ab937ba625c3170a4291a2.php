<div class="accordion-row bg-white rounded-lg border border-gray300 mt-3 py-3 py-lg-4 px-2 px-lg-3">
    <div class="d-flex align-items-center justify-content-between " role="tab" id="specification_<?php echo e(!empty($selectedSpecification) ? $selectedSpecification->id :'record'); ?>">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(!empty($selectedSpecification)): ?>
                <?php echo $__env->make('admin.includes.delete_button',['url' => getAdminPanelUrl().'/store/products/specifications/'. $selectedSpecification->id .'/delete','btnClass' => 'mr-3', 'btnText' => '<i class="fa fa-trash"></i>'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
    ...
    <div id="collapseSpecification<?php echo e(!empty($selectedSpecification) ? $selectedSpecification->id :'record'); ?>" aria-labelledby="specification_<?php echo e(!empty($selectedSpecification) ? $selectedSpecification->id :'record'); ?>" class=" collapse <?php if(empty($selectedSpecification)): ?> show <?php endif; ?>" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="js-content-form specification-form" data-action="<?php echo e(getAdminPanelUrl()); ?>/store/products/specifications/<?php echo e(!empty($selectedSpecification) ? $selectedSpecification->id . '/update' : 'store'); ?>">
...
<?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\admin\store\products\create\accordions\specification.blade.php ENDPATH**/ ?>