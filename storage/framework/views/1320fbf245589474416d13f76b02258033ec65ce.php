                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("admin_comments_status")): ?>
                                                            <a href="<?php echo e(getAdminPanelUrl("/comments/product_reviews/{$reply->id}/toggle")); ?>" class="btn-transparent text-primary">
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("admin_comments_edit")): ?>
                                                            <a href="<?php echo e(getAdminPanelUrl("/comments/product_reviews/{$reply->id}/edit")); ?>" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                        <?php endif; ?>

                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("admin_comments_delete")): ?>
                                                            <?php echo $__env->make('admin.includes.delete_button',['url' => getAdminPanelUrl("/comments/product_reviews/{$reply->id}/delete"), 'btnClass' => 'btn-sm mt-2'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("admin_comments_reply")): ?>
                            <div class="card-body ">
                                <form action="<?php echo e(getAdminPanelUrl("/comments/product_reviews/{$review->id}/reply")); ?>" method="post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BraIT\Desktop\Dev\braitacademy\resources\views\admin\store\reviews\comment_reply.blade.php ENDPATH**/ ?>