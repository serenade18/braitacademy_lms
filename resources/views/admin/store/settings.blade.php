                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <form action="{{ getAdminPanelUrl() }}/store/settings" method="post">
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            ...
                                            <div class="text-muted text-small">{{ trans('update.admin_store_setting_show_address_selection_in_cart_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            ...
                                            <div class="text-muted text-small">{{ trans('update.admin_store_setting_take_address_selection_optional_hint') }}</div>
                                        </div>
